...
async function main() {
    ...
    const lokasi1 = await prisma.tempat_latihan.upsert({
        ...
        create: {
            ...
            kapasitas: 50,
            status: client_1.StatusLokasi.Aktif,
        },
    });
    ...
    const userPelatih1 = await prisma.users.upsert({
        ...
        create: {
            ...
            role: client_1.UserRole.pelatih,
            status: 'active',
        },
    });
    const pelatih1 = await prisma.pelatih_profiles.upsert({
        ...
        create: {
            ...
            jenis_kelamin: client_1.JenisKelamin.Laki_laki,
    ...
    const pelatih2 = await prisma.pelatih_profiles.upsert({
        ...
        create: {
            ...
            jenis_kelamin: client_1.JenisKelamin.Perempuan,
    ...
    await prisma.anggota_profiles.upsert({
        ...
        create: {
            ...
            sabuk: 'Biru_Polos',
            tanggal_gabung: new Date('2020-01-15'),
            status_keanggotaan: client_1.StatusKeanggotaan.Aktif,
    ...
    for (const data of anggotaData) {
        const user = await prisma.users.upsert({
            ...
            create: {
                ...
                role: client_1.UserRole.anggota,
                status: 'active',
            },
        });
        await prisma.anggota_profiles.upsert({
